...
# 61 "User/lib/test/test_dsp.c" 3 4
                                                3.14159265358979323846 
# 61 "User/lib/test/test_dsp.c"
                                                     / 180.0f;
    for (uint32_t i = 0; i < len; i++)
        buf[i] = amp * sinf((2.0f * (float32_t)
# 63 "User/lib/test/test_dsp.c" 3 4
                           3.14159265358979323846
# 63 "User/lib/test/test_dsp.c"
...
# 112 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 112 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(112));
    UnityAssertFloatsWithin((UNITY_FLOAT)((0.005f)), (UNITY_FLOAT)((expected_rms)), (UNITY_FLOAT)((dat.rms_current)), (
# 113 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 113 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(113));
}
...
# 128 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 128 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(128));
    UnityAssertFloatsWithin((UNITY_FLOAT)((0.01f)), (UNITY_FLOAT)((expected_app)), (UNITY_FLOAT)((dat.app_pwr)), (
# 129 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 129 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(129));
    UnityAssertFloatsWithin((UNITY_FLOAT)((0.01f)), (UNITY_FLOAT)((1.0f)), (UNITY_FLOAT)((dat.pf)), (
# 130 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 130 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(130));
}
...
# 150 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 150 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(150));
}
...
# 169 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 169 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(169));
}
...
# 190 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 190 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(190));
    UnityAssertFloatsWithin((UNITY_FLOAT)((0.005f)), (UNITY_FLOAT)((base_rms * 3.0f)), (UNITY_FLOAT)((dat.rms_current)), (
# 191 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 191 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(191));
}
...
void test_dsp_phase_act_pwr_never_exceeds_app_pwr(void)
{
    ...
    do { if ((dat.act_pwr <= dat.app_pwr + 1e-4f)) { } else { UnityFail( ((("act_pwr exceeded app_pwr"))), (UNITY_UINT)((208))); } } while (0)
                                                        ;
}
...
# 225 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 225 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(225));
    UnityAssertFloatsWithin((UNITY_FLOAT)((1e-6f)), (UNITY_FLOAT)((0.0f)), (UNITY_FLOAT)((dat.rms_current)), (
# 226 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 226 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(226));
    UnityAssertFloatsWithin((UNITY_FLOAT)((1e-6f)), (UNITY_FLOAT)((0.0f)), (UNITY_FLOAT)((dat.act_pwr)), (
# 227 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 227 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(227));
    UnityAssertFloatsWithin((UNITY_FLOAT)((1e-6f)), (UNITY_FLOAT)((0.0f)), (UNITY_FLOAT)((dat.app_pwr)), (
# 228 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 228 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(228));


}
# 240 "User/lib/test/test_dsp.c"
...
# 288 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 288 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(288))
                                                                         ;
}
...
# 312 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 312 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(312));
    UnityAssertFloatsWithin((UNITY_FLOAT)((1e-6f)), (UNITY_FLOAT)((0.0f)), (UNITY_FLOAT)((mdat.vol_line.bc)), (
# 313 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 313 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(313));
    UnityAssertFloatsWithin((UNITY_FLOAT)((1e-6f)), (UNITY_FLOAT)((0.0f)), (UNITY_FLOAT)((mdat.vol_line.ca)), (
# 314 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 314 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(314));
}
...
# 331 "User/lib/test/test_dsp.c" 3 4
                     3.14159265358979323846
# 331 "User/lib/test/test_dsp.c"
...
# 335 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 335 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(335));
}
...
void test_dsp_fre_3p_updates_frequency(void)
{
    ...
    UnityAssertFloatsWithin((UNITY_FLOAT)((2.0f)), (UNITY_FLOAT)((50.0f)), (UNITY_FLOAT)((mdat.frequency)), (
# 352 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 352 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(352));
}
...
# 405 "User/lib/test/test_dsp.c" 3 4
                           3.14159265358979323846
# 405 "User/lib/test/test_dsp.c"
                           ) * 50.0f * (float32_t)i / 6400.0f)
                + harmonic_amp * 1.0f * sinf((2.0f * (float32_t)
# 406 "User/lib/test/test_dsp.c" 3 4
                                          3.14159265358979323846
# 406 "User/lib/test/test_dsp.c"
...
void test_dsp_thd_with_3rd_and_5th_harmonic(void)
{
    ...
    for (uint32_t i = 0; i < (128U * 8); i++) {
        data[i] = 1.0f * sinf((2.0f * (float32_t)
# 431 "User/lib/test/test_dsp.c" 3 4
                           3.14159265358979323846
# 431 "User/lib/test/test_dsp.c"
                           ) * 50.0f * (float32_t)i / 6400.0f)
                + 0.20f * 1.0f * sinf((2.0f * (float32_t)
# 432 "User/lib/test/test_dsp.c" 3 4
                                   3.14159265358979323846
# 432 "User/lib/test/test_dsp.c"
                                   ) * 3.0f * 50.0f * (float32_t)i / 6400.0f)
                + 0.10f * 1.0f * sinf((2.0f * (float32_t)
# 433 "User/lib/test/test_dsp.c" 3 4
                                   3.14159265358979323846
# 433 "User/lib/test/test_dsp.c"
...
# 465 "User/lib/test/test_dsp.c" 3 4
   ((void *)0)
# 465 "User/lib/test/test_dsp.c"
   ), (UNITY_UINT)(465));
}
...
void test_dsp_thd_angle_cosine_input(void)
{
    ...
    do { if ((!
# 487 "User/lib/test/test_dsp.c" 3 4
   __builtin_isnan (
# 487 "User/lib/test/test_dsp.c"
   angle
# 487 "User/lib/test/test_dsp.c" 3 4
   ) 
# 487 "User/lib/test/test_dsp.c"
...
# 489 "User/lib/test/test_dsp.c" 3 4
   3.14159265358979323846 
# 489 "User/lib/test/test_dsp.c"
   && angle <= (float32_t)
# 489 "User/lib/test/test_dsp.c" 3 4
   3.14159265358979323846
# 489 "User/lib/test/test_dsp.c"
