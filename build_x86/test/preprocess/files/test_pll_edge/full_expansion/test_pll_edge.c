# 0 "User/lib/test/test_pll_edge.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "User/lib/test/test_pll_edge.c"
# 17 "User/lib/test/test_pll_edge.c"
...
# 18 "User/lib/test/test_pll_edge.c" 2
...
# 19 "User/lib/test/test_pll_edge.c" 2
# 38 "User/lib/test/test_pll_edge.c"
...
# 45 "User/lib/test/test_pll_edge.c" 3 4
               3.14159265358979323846
# 45 "User/lib/test/test_pll_edge.c"
               ) * f * (float32_t)i / fs);
}
...
# 51 "User/lib/test/test_pll_edge.c" 3 4
                   3.14159265358979323846
# 51 "User/lib/test/test_pll_edge.c"
                   ) * f * (float32_t)i / fs;
    *va = sinf(phi);
    *vb = sinf(phi - (2.0f * (float32_t)
# 53 "User/lib/test/test_pll_edge.c" 3 4
                    3.14159265358979323846
# 53 "User/lib/test/test_pll_edge.c"
                    ) / 3.0f);
    *vc = sinf(phi - 2.0f * (2.0f * (float32_t)
# 54 "User/lib/test/test_pll_edge.c" 3 4
                           3.14159265358979323846
# 54 "User/lib/test/test_pll_edge.c"
                           ) / 3.0f);
}
...
void setUp(void) {}
void tearDown(void) {}
# 95 "User/lib/test/test_pll_edge.c"
void test_edge_1p_zero_input_theta_stays_valid(void)
{
    ...
    for (uint32_t i = 0; i < samples; i++) {
        ...
        do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((("theta out of [0,360) on zero input"))), (UNITY_UINT)((103))); } } while (0)
                                                                      ;
    }
}
...
void test_edge_3p_zero_input_theta_stays_valid(void)
{
    ...
    for (uint32_t i = 0; i < samples; i++) {
        ...
        do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((("theta out of [0,360) on zero input"))), (UNITY_UINT)((116))); } } while (0)
                                                                      ;
    }
}
...
# 139 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 139 "User/lib/test/test_pll_edge.c"
...
void test_edge_3p_zero_input_clears_lock(void)
{
    ...
    for (uint32_t i = 0; i < spc; i++) {
        pll_update_3p(&pll, 0.0f, 0.0f, 0.0f);
        do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((156))); } } while (0);
    }

    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((1)), (UNITY_INT)(UNITY_UINT32)((pll_is_locked(&pll))), (
# 159 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 159 "User/lib/test/test_pll_edge.c"
   ), (UNITY_UINT)(159), UNITY_DISPLAY_STYLE_UINT32);
}
# 170 "User/lib/test/test_pll_edge.c"
void test_edge_1p_large_amplitude_theta_valid(void)
{
    ...
    for (uint32_t i = 0; i < samples; i++) {
        ...
        do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((179))); } } while (0);
    }

    do { if ((pll.fre > 10.0f && pll.fre < 200.0f)) { } else { UnityFail( ((("fre diverged on large amplitude input"))), (UNITY_UINT)((182))); } } while (0)
                                                                     ;
}
...
void test_edge_3p_large_amplitude_theta_valid(void)
{
    ...
    for (uint32_t i = 0; i < samples; i++) {
        ...
        do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((196))); } } while (0);
    }
    do { if ((pll.fre > 10.0f && pll.fre < 200.0f)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((198))); } } while (0);
}
# 209 "User/lib/test/test_pll_edge.c"
...
# 229 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 229 "User/lib/test/test_pll_edge.c"
   ), (UNITY_UINT)(229));
}
# 239 "User/lib/test/test_pll_edge.c"
void test_edge_1p_signal_loss_and_recovery(void)
{
    ...
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((1)), (UNITY_INT)(UNITY_UINT32)((pll_is_locked(&pll))), (
# 246 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 246 "User/lib/test/test_pll_edge.c"
    ...
    do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((256))); } } while (0);
...
void test_edge_3p_signal_loss_and_recovery(void)
{
    ...
    uint32_t offset = run_3p(&pll, 50.0f, 50, 0);
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((1)), (UNITY_INT)(UNITY_UINT32)((pll_is_locked(&pll))), (
# 278 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 278 "User/lib/test/test_pll_edge.c"
    ...
    do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((287))); } } while (0);
    UnityAssertFloatsWithin((UNITY_FLOAT)((5.0f)), (UNITY_FLOAT)((50.0f)), (UNITY_FLOAT)((pll.fre)), (
# 288 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 288 "User/lib/test/test_pll_edge.c"
   ), (UNITY_UINT)(288));
}
# 299 "User/lib/test/test_pll_edge.c"
void test_edge_3p_phase_jump_180_recovers(void)
{
    ...
    uint32_t offset = run_3p(&pll, 50.0f, 50, 0);
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((1)), (UNITY_INT)(UNITY_UINT32)((pll_is_locked(&pll))), (
# 305 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 305 "User/lib/test/test_pll_edge.c"
    ...
    for (uint32_t i = 0; i < max_samples; i++) {
        ...
        sine_3p(offset + i, 50.0f, 6400.0f, &va, &vb, &vc);
        pll_update_3p(&pll, -va, -vb, -vc);
        do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((314))); } } while (0);
        if (pll_is_locked(&pll)) { relocked = 1; break; }
    }
...
void test_edge_1p_phase_jump_180_recovers(void)
{
    ...
    uint32_t offset = run_1p(&pll, 50.0f, 50, 0);
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((1)), (UNITY_INT)(UNITY_UINT32)((pll_is_locked(&pll))), (
# 327 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 327 "User/lib/test/test_pll_edge.c"
    ...
    for (uint32_t i = 0; i < max_samples; i++) {
        pll_update_1p(&pll, -sine_1p(offset + i, 50.0f, 6400.0f));
        do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((333))); } } while (0);
        if (pll_is_locked(&pll)) { relocked = 1; break; }
    }
...
void test_edge_3p_locks_at_45Hz(void)
{
    ...
    for (uint32_t i = 0; i < max_samples; i++) {
        ...
        pll_update_3p(&pll, va, vb, vc);
        do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((356))); } } while (0);
...
# 360 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 360 "User/lib/test/test_pll_edge.c"
   ), (UNITY_UINT)(360));
}
...
void test_edge_3p_locks_at_65Hz(void)
{
    ...
    for (uint32_t i = 0; i < max_samples; i++) {
        ...
        sine_3p(i, f, 6400.0f, &va, &vb, &vc);
        pll_update_3p(&pll, va, vb, vc);
        do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((375))); } } while (0);
        if (pll_is_locked(&pll)) { locked = 1; break; }
    }
    ...
    UnityAssertFloatsWithin((UNITY_FLOAT)((2.0f)), (UNITY_FLOAT)((f)), (UNITY_FLOAT)((pll.fre)), (
# 379 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 379 "User/lib/test/test_pll_edge.c"
   ), (UNITY_UINT)(379));
}
# 389 "User/lib/test/test_pll_edge.c"
void test_edge_update_fs_arr_clamped_at_50Hz(void)
{
    ...
    do { if ((f_new >= 44.0f && f_new <= 66.0f)) { } else { UnityFail( ((("pll_update_fs produced fs outside 45-65Hz range"))), (UNITY_UINT)((401))); } } while (0)
                                                                               ;
...
void test_edge_update_fs_clamps_below_45Hz(void)
{
    ...
    do { if ((f_new >= 44.0f)) { } else { UnityFail( ((("pll_update_fs did not clamp frequency below 45Hz"))), (UNITY_UINT)((418))); } } while (0)
                                                                                ;
}
...
void test_edge_update_fs_clamps_above_65Hz(void)
{
    ...
    float32_t f_new = pll.fs / 128.0f;
    do { if ((f_new <= 66.0f)) { } else { UnityFail( ((("pll_update_fs did not clamp frequency above 65Hz"))), (UNITY_UINT)((433))); } } while (0)
                                                                                ;
}
# 444 "User/lib/test/test_pll_edge.c"
void test_edge_1p_single_update_after_init(void)
{
    ...
    do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((450))); } } while (0);
    do { if (!(
# 451 "User/lib/test/test_pll_edge.c" 3 4
   __builtin_isnan (
# 451 "User/lib/test/test_pll_edge.c"
   pll.fre
# 451 "User/lib/test/test_pll_edge.c" 3 4
   )
# 451 "User/lib/test/test_pll_edge.c"
    ...
    do { if (!(
# 452 "User/lib/test/test_pll_edge.c" 3 4
   __builtin_isinf_sign (
# 452 "User/lib/test/test_pll_edge.c"
   pll.fre
# 452 "User/lib/test/test_pll_edge.c" 3 4
   )
# 452 "User/lib/test/test_pll_edge.c"
...
void test_edge_3p_single_update_after_init(void)
{
    ...
    do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((461))); } } while (0);
    do { if (!(
# 462 "User/lib/test/test_pll_edge.c" 3 4
   __builtin_isnan (
# 462 "User/lib/test/test_pll_edge.c"
   pll.fre
# 462 "User/lib/test/test_pll_edge.c" 3 4
   )
# 462 "User/lib/test/test_pll_edge.c"
    ...
    do { if (!(
# 463 "User/lib/test/test_pll_edge.c" 3 4
   __builtin_isinf_sign (
# 463 "User/lib/test/test_pll_edge.c"
   pll.fre
# 463 "User/lib/test/test_pll_edge.c" 3 4
   )
# 463 "User/lib/test/test_pll_edge.c"
...
# 473 "User/lib/test/test_pll_edge.c"
void test_edge_1p_reinit_while_running_resets_state(void)
{
    ...
    run_1p(&pll, 50.0f, 50, 0);
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((1)), (UNITY_INT)(UNITY_UINT32)((pll_is_locked(&pll))), (
# 478 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 478 "User/lib/test/test_pll_edge.c"
...
# 483 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 483 "User/lib/test/test_pll_edge.c"
   ), (UNITY_UINT)(483));
    UnityAssertFloatsWithin((UNITY_FLOAT)((1e-6f)), (UNITY_FLOAT)((0.0f)), (UNITY_FLOAT)((pll.SOGI.alpha)), (
# 484 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 484 "User/lib/test/test_pll_edge.c"
   ), (UNITY_UINT)(484));
    UnityAssertFloatsWithin((UNITY_FLOAT)((1e-6f)), (UNITY_FLOAT)((0.0f)), (UNITY_FLOAT)((pll.SOGI.beta)), (
# 485 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 485 "User/lib/test/test_pll_edge.c"
   ), (UNITY_UINT)(485));
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((0)), (UNITY_INT)(UNITY_UINT32)((pll_is_locked(&pll))), (
# 486 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 486 "User/lib/test/test_pll_edge.c"
...
void test_edge_3p_reinit_while_running_resets_state(void)
{
    ...
    run_3p(&pll, 50.0f, 50, 0);
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((1)), (UNITY_INT)(UNITY_UINT32)((pll_is_locked(&pll))), (
# 494 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 494 "User/lib/test/test_pll_edge.c"
   ), (UNITY_UINT)(494), UNITY_DISPLAY_STYLE_UINT32);

    pll_init_3p(&pll, 50.0f, 6400.0f);

    UnityAssertFloatsWithin((UNITY_FLOAT)((0.001f)), (UNITY_FLOAT)((270.0f)), (UNITY_FLOAT)((pll.theta)), (
# 498 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 498 "User/lib/test/test_pll_edge.c"
   ), (UNITY_UINT)(498));
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((0)), (UNITY_INT)(UNITY_UINT32)((pll_is_locked(&pll))), (
# 499 "User/lib/test/test_pll_edge.c" 3 4
   ((void *)0)
# 499 "User/lib/test/test_pll_edge.c"
