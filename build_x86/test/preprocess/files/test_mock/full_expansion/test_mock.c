...
# 8 "User/mock/inc/mock_hw_stub.h"
...
{ (void)f;(void)n;(void)s;(void)p;(void)prio;(void)st;(void)buf; return 
# 24 "User/mock/inc/mock_hw_stub.h" 3 4
                                                                       ((void *)0)
# 24 "User/mock/inc/mock_hw_stub.h"
                                                                           ; }
...
# 41 "build_x86/vendor/unity/src/unity_internals.h"
...
# 51 "User/mock/test/test_mock.c"
void setUp(void) {}
void tearDown(void) {}
# 61 "User/mock/test/test_mock.c"
void test_mock_sin_gen_output_within_adc_range(void)
{
    ...
    for (uint32_t i = 0; i < 128U; i++) {
        do { if ((buf[i] <= (uint16_t)4096.0f)) { } else { UnityFail( ((("Sample above ADC_MAX"))), (UNITY_UINT)((69))); } } while (0)
                                                        ;
    }
}
...
# 87 "User/mock/test/test_mock.c" 3 4
   ((void *)0)
# 87 "User/mock/test/test_mock.c"
   ), (UNITY_UINT)(87));
}
...
# 137 "User/mock/test/test_mock.c" 3 4
   ((void *)0)
# 137 "User/mock/test/test_mock.c"
   ), (UNITY_UINT)(137));
}
...
# 153 "User/mock/test/test_mock.c" 3 4
   ((void *)0)
# 153 "User/mock/test/test_mock.c"
   ), (UNITY_UINT)(153));
}
...
void test_mock_sin_gen_different_frequencies_differ(void)
{
    ...
    do { if ((diff_count > 128U / 2)) { } else { UnityFail( ((("50Hz and 60Hz buffers should differ significantly"))), (UNITY_UINT)((169))); } } while (0)
                                                                                 ;
}
# 181 "User/mock/test/test_mock.c"
void test_mock_3p_all_samples_within_adc_range(void)
{
    ...
    for (uint32_t i = 0; i < 128U * (3U * 2U); i++) {
        do { if ((buf[i] <= (uint16_t)4096.0f)) { } else { UnityFail( ((("3p sample above ADC_MAX"))), (UNITY_UINT)((190))); } } while (0)
                                                           ;
    }
}
...
void test_mock_3p_current_phase_shift_applied(void)
{
    ...
    do { if ((ia_diff > 0)) { } else { UnityFail( ((("Current channel did not change with i_phase_shift"))), (UNITY_UINT)((265))); } } while (0)
                                                                                 ;
}
...
# 278 "User/mock/test/test_mock.c" 3 4
   ((void *)0)
# 278 "User/mock/test/test_mock.c"
   ), (UNITY_UINT)(278), UNITY_DISPLAY_STYLE_HEX16);
}
# 290 "User/mock/test/test_mock.c"
void test_mock_DMA_init_registers_buffer(void)
{
    ...
    do { if ((changed > 0)) { } else { UnityFail( ((("buf_a should have been written"))), (UNITY_UINT)((306))); } } while (0);


    for (uint32_t i = 0; i < 128U * (3U * 2U); i++)
        UnityAssertEqualNumber((UNITY_INT)(UNITY_INT16)((0xBBBB)), (UNITY_INT)(UNITY_INT16)((buf_b[i])), (
# 310 "User/mock/test/test_mock.c" 3 4
       ((void *)0)
# 310 "User/mock/test/test_mock.c"
       ), (UNITY_UINT)(310), UNITY_DISPLAY_STYLE_HEX16);
}
# 324 "User/mock/test/test_mock.c"
void test_mock_timer_update_arr_no_crash(void)
{
    ...
    for (uint32_t i = 0; i < 128U * (3U * 2U); i++)
        do { if ((buf[i] <= (uint16_t)4096.0f)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((334))); } } while (0);
}
...
void test_mock_timer_update_arr_changes_internal_fs(void)
{
    ...
    mock_sin_gen_ui_3_p(buf, 128U * (3U * 2U), 50.0f, 6400.0f, 0.0f);
    for (uint32_t i = 0; i < 128U * (3U * 2U); i++)
        do { if ((buf[i] <= (uint16_t)4096.0f)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((350))); } } while (0);
}
