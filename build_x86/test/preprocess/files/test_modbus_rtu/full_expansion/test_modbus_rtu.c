# 0 "User/lib/test/test_modbus_rtu.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "User/lib/test/test_modbus_rtu.c"
# 20 "User/lib/test/test_modbus_rtu.c"
...
# 21 "User/lib/test/test_modbus_rtu.c" 2
# 1 "User/lib/inc/modbus_rtu.h" 1
...
# 9 "User/lib/inc/modbus_rtu.h" 2
# 1 "User/lib/inc/calib.h" 1
# 106 "User/lib/inc/calib.h"
...
# 13 "User/lib/inc/modbus_rtu.h" 2
# 1 "User/sup/inc/stm32f4xx_ll_dma.h" 1



typedef struct { volatile uint32_t dummy; } DMA_TypeDef;
static DMA_TypeDef _stub_dma1 = {0};
# 14 "User/lib/inc/modbus_rtu.h" 2
# 1 "User/sup/inc/stm32f4xx_ll_bus.h" 1
# 15 "User/lib/inc/modbus_rtu.h" 2
# 1 "User/sup/inc/stm32f4xx_ll_gpio.h" 1
# 9 "User/sup/inc/stm32f4xx_ll_gpio.h"
typedef struct {
...
# 16 "User/lib/inc/modbus_rtu.h" 2
# 1 "User/sup/inc/FreeRTOS.h" 1
...
# 17 "User/lib/inc/modbus_rtu.h" 2
# 1 "User/sup/inc/task.h" 1


# 1 "User/sup/inc/FreeRTOS.h" 1
# 4 "User/sup/inc/task.h" 2
# 18 "User/lib/inc/modbus_rtu.h" 2
# 84 "User/lib/inc/modbus_rtu.h"
enum mb_status {
 mb_ok = 0,
 mb_err_init,
 mb_err_crc,
...
struct mb_data_store {
 uint8_t coils[64 / 8 + 1];
 uint8_t discrete_inputs[64 / 8 + 1];
 uint16_t input_regs[32];
 uint16_t holding_regs[(0x004A + ((((0x0128 + 2) + 2)) + 2))];
};
# 110 "User/lib/inc/modbus_rtu.h"
...
void mb_set_coil(uint16_t addr, 
# 129 "User/lib/inc/modbus_rtu.h" 3 4
                               _Bool 
# 129 "User/lib/inc/modbus_rtu.h"
                                    val);

# 130 "User/lib/inc/modbus_rtu.h" 3 4
_Bool 
# 130 "User/lib/inc/modbus_rtu.h"
    mb_get_coil(uint16_t addr);

void mb_set_discrete_input(uint16_t addr, 
# 132 "User/lib/inc/modbus_rtu.h" 3 4
                                         _Bool 
# 132 "User/lib/inc/modbus_rtu.h"
                                              val);

# 133 "User/lib/inc/modbus_rtu.h" 3 4
_Bool 
# 133 "User/lib/inc/modbus_rtu.h"
    mb_get_discrete_input(uint16_t addr);
...
# 22 "User/lib/test/test_modbus_rtu.c" 2
# 32 "User/lib/test/test_modbus_rtu.c"
...
void tearDown(void) {}
# 118 "User/lib/test/test_modbus_rtu.c"
...
# 125 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 125 "User/lib/test/test_modbus_rtu.c"
...
# 126 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 126 "User/lib/test/test_modbus_rtu.c"
...
void test_crc16_single_byte(void)
{
    ...
    do { if (((0x0000) != (crc))) { } else { UnityFail( ((" Expected Not-Equal")), (UNITY_UINT)((133))); } } while (0);
    do { if (((0xFFFF) != (crc))) { } else { UnityFail( ((" Expected Not-Equal")), (UNITY_UINT)((134))); } } while (0);
}
...
# 142 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 142 "User/lib/test/test_modbus_rtu.c"
...
void test_crc16_bit_flip_changes_crc(void)
{
    ...
    do { if (((crc16(frame1,6)) != (crc16(frame2,6)))) { } else { UnityFail( ((" Expected Not-Equal")), (UNITY_UINT)((149))); } } while (0);
}
...
# 159 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 159 "User/lib/test/test_modbus_rtu.c"
   ), (UNITY_UINT)(159));
}
...
# 165 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 165 "User/lib/test/test_modbus_rtu.c"
   ), (UNITY_UINT)(165));
}
...
# 171 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 171 "User/lib/test/test_modbus_rtu.c"
   ), (UNITY_UINT)(171));
}
...
# 177 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 177 "User/lib/test/test_modbus_rtu.c"
   ), (UNITY_UINT)(177));
}
...
# 186 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 186 "User/lib/test/test_modbus_rtu.c"
   ), (UNITY_UINT)(186), UNITY_DISPLAY_STYLE_HEX16);
    UnityAssertEqualNumber((UNITY_INT)(UNITY_INT16)((0x0000)), (UNITY_INT)(UNITY_INT16)((lo)), (
# 187 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 187 "User/lib/test/test_modbus_rtu.c"
...
# 194 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 194 "User/lib/test/test_modbus_rtu.c"
...
# 195 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 195 "User/lib/test/test_modbus_rtu.c"
...
# 205 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 205 "User/lib/test/test_modbus_rtu.c"
...
# 212 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 212 "User/lib/test/test_modbus_rtu.c"
...
# 217 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 217 "User/lib/test/test_modbus_rtu.c"
...
# 231 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 231 "User/lib/test/test_modbus_rtu.c"
...
# 232 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 232 "User/lib/test/test_modbus_rtu.c"
...
# 233 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 233 "User/lib/test/test_modbus_rtu.c"
...
{
    mb_set_coil(0, 
# 242 "User/lib/test/test_modbus_rtu.c" 3 4
                  1
# 242 "User/lib/test/test_modbus_rtu.c"
                      );
    do { if ((mb_get_coil(0))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((243))); } } while (0);
}

void test_coil_set_false_get_false(void)
{
    mb_set_coil(0, 
# 248 "User/lib/test/test_modbus_rtu.c" 3 4
                  1
# 248 "User/lib/test/test_modbus_rtu.c"
                      );
    mb_set_coil(0, 
# 249 "User/lib/test/test_modbus_rtu.c" 3 4
                  0
# 249 "User/lib/test/test_modbus_rtu.c"
                       );
    do { if (!(mb_get_coil(0))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((250))); } } while (0);
}

void test_coil_adjacent_bits_independent(void)
{
    mb_set_coil(0, 
# 255 "User/lib/test/test_modbus_rtu.c" 3 4
                  1
# 255 "User/lib/test/test_modbus_rtu.c"
                      );
    mb_set_coil(1, 
# 256 "User/lib/test/test_modbus_rtu.c" 3 4
                  0
# 256 "User/lib/test/test_modbus_rtu.c"
                       );
    mb_set_coil(2, 
# 257 "User/lib/test/test_modbus_rtu.c" 3 4
                  1
# 257 "User/lib/test/test_modbus_rtu.c"
                      );
    do { if ((mb_get_coil(0))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((258))); } } while (0);
    do { if (!(mb_get_coil(1))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((259))); } } while (0);
    do { if ((mb_get_coil(2))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((260))); } } while (0);
}

void test_coil_boundary_last(void)
{
    mb_set_coil(64 - 1, 
# 265 "User/lib/test/test_modbus_rtu.c" 3 4
                                      1
# 265 "User/lib/test/test_modbus_rtu.c"
                                          );
    do { if ((mb_get_coil(64 - 1))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((266))); } } while (0);
}

void test_coil_out_of_bounds_read_returns_false(void)
{
    do { if (!(mb_get_coil(64))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((271))); } } while (0);
}
...
void test_coil_byte_boundary(void)
{
    ...
    mb_set_coil(7, 
# 277 "User/lib/test/test_modbus_rtu.c" 3 4
                  1
# 277 "User/lib/test/test_modbus_rtu.c"
                      );
    mb_set_coil(8, 
# 278 "User/lib/test/test_modbus_rtu.c" 3 4
                  0
# 278 "User/lib/test/test_modbus_rtu.c"
                       );
    do { if ((mb_get_coil(7))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((279))); } } while (0);
    do { if (!(mb_get_coil(8))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((280))); } } while (0);
}
...
# 289 "User/lib/test/test_modbus_rtu.c" 3 4
                            1
# 289 "User/lib/test/test_modbus_rtu.c"
                                );
    do { if ((mb_get_discrete_input(0))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((290))); } } while (0);
}

void test_discrete_input_clear(void)
{
    mb_set_discrete_input(5, 
# 295 "User/lib/test/test_modbus_rtu.c" 3 4
                            1
# 295 "User/lib/test/test_modbus_rtu.c"
                                );
    mb_set_discrete_input(5, 
# 296 "User/lib/test/test_modbus_rtu.c" 3 4
                            0
# 296 "User/lib/test/test_modbus_rtu.c"
                                 );
    do { if (!(mb_get_discrete_input(5))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((297))); } } while (0);
}

void test_discrete_input_out_of_bounds_returns_false(void)
{
    do { if (!(mb_get_discrete_input(64))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((302))); } } while (0);
}
...
# 312 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 312 "User/lib/test/test_modbus_rtu.c"
...
# 319 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 319 "User/lib/test/test_modbus_rtu.c"
...
# 324 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 324 "User/lib/test/test_modbus_rtu.c"
...
# 333 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 333 "User/lib/test/test_modbus_rtu.c"
...
# 340 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 340 "User/lib/test/test_modbus_rtu.c"
...
{
    mb_set_coil(3, 
# 345 "User/lib/test/test_modbus_rtu.c" 3 4
                  1
# 345 "User/lib/test/test_modbus_rtu.c"
                      );
    struct mb_data_store *ds = mb_get_data_store();
    do { if (((ds->coils[0] >> 3) & 1u)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((347))); } } while (0);
}
# 360 "User/lib/test/test_modbus_rtu.c"
...
# 363 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 363 "User/lib/test/test_modbus_rtu.c"
...
# 369 "User/lib/test/test_modbus_rtu.c" 3 4
   ((void *)0)
# 369 "User/lib/test/test_modbus_rtu.c"
...
{
    mb_set_coil(10, 
# 374 "User/lib/test/test_modbus_rtu.c" 3 4
                   1
# 374 "User/lib/test/test_modbus_rtu.c"
                       );
    do { if ((mb_get_coil(10))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((375))); } } while (0);
    mb_set_coil(10, 
# 376 "User/lib/test/test_modbus_rtu.c" 3 4
                   0
# 376 "User/lib/test/test_modbus_rtu.c"
                        );
    do { if (!(mb_get_coil(10))) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((377))); } } while (0);
}
