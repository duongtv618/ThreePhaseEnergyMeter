# 0 "User/safety/test/test_ram_pat_ck.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 0 "<command-line>" 2
# 1 "User/safety/test/test_ram_pat_ck.c"
...
# 2 "User/safety/test/test_ram_pat_ck.c" 2
# 1 "User/safety/inc/ram_pat_ck.h" 1
...
# 5 "User/safety/inc/ram_pat_ck.h" 2
...
# 3 "User/safety/test/test_ram_pat_ck.c" 2
