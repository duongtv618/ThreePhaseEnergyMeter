# 0 "User/common/test/test_ema_maf_shdat.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 0 "<command-line>" 2
# 1 "User/common/test/test_ema_maf_shdat.c"
/**
...
# 11 "User/common/test/test_ema_maf_shdat.c" 2
# 1 "User/common/inc/ema.h" 1
...
# 5 "User/common/inc/ema.h" 2


float32_t ema_get(float32_t in, float32_t last, float32_t alpha);

# 12 "User/common/test/test_ema_maf_shdat.c" 2
...
# 13 "User/common/test/test_ema_maf_shdat.c" 2
# 1 "User/common/inc/share_data.h" 1
...
# 14 "User/common/test/test_ema_maf_shdat.c" 2
# 1 "User/common/inc/share_types.h" 1
# 15 "User/common/test/test_ema_maf_shdat.c" 2
...
#define MAF_SIZE MAF_MAX_SAMPLES
#define TOL 1e-4f
