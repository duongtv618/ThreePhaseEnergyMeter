...
# 10 "User/common/test/test_ema_maf_shdat.c"
...
# 25 "User/common/test/test_ema_maf_shdat.c"
...
void setUp(void) {}
void tearDown(void) {}
# 58 "User/common/test/test_ema_maf_shdat.c"
...
# 61 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 61 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(61));
}
...
# 67 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 67 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(67));
}
...
# 73 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 73 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(73));
}
...
# 82 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 82 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(82));
}
...
void test_ema_step_response_monotonic(void)
{
    ...
    for (int i = 0; i < 50; i++) {
        ...
        do { if ((val >= prev)) { } else { UnityFail( ((("EMA not monotonically increasing"))), (UNITY_UINT)((91))); } } while (0);
        prev = val;
    }
}
...
void test_ema_negative_input(void)
{
    float32_t result = ema_get(-10.0f, 0.0f, 0.5f);
    UnityAssertFloatsWithin((UNITY_FLOAT)((1e-4f)), (UNITY_FLOAT)((-5.0f)), (UNITY_FLOAT)((result)), (
# 99 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 99 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(99));
}
...
# 104 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 104 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(104));
}
...
# 117 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 117 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(117), UNITY_DISPLAY_STYLE_UINT32);
    UnityAssertFloatsWithin((UNITY_FLOAT)((1e-4f)), (UNITY_FLOAT)((0.0f)), (UNITY_FLOAT)((maf.sum)), (
# 118 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 118 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(118));
}
...
# 127 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 127 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(127));
}
...
# 138 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 138 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(138));
}
...
# 150 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 150 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(150));
}
...
# 164 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 164 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(164));
}
...
void test_maf_sample_count_wraps_at_max(void)
{
    ...
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((0)), (UNITY_INT)(UNITY_UINT32)((maf.sample_count)), (
# 174 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 174 "User/common/test/test_ema_maf_shdat.c"
...
# 184 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 184 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(184));
}
...
void test_maf_negative_samples(void)
{
    ...
    UnityAssertFloatsWithin((UNITY_FLOAT)((1e-4f)), (UNITY_FLOAT)((-5.0f)), (UNITY_FLOAT)((result)), (
# 194 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 194 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(194));
}
...
# 215 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 215 "User/common/test/test_ema_maf_shdat.c"
...
# 221 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 221 "User/common/test/test_ema_maf_shdat.c"
...
# 241 "User/common/test/test_ema_maf_shdat.c" 3 4
       ((void *)0)
# 241 "User/common/test/test_ema_maf_shdat.c"
...
# 253 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 253 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(253));
}
...
# 264 "User/common/test/test_ema_maf_shdat.c" 3 4
       ((void *)0)
# 264 "User/common/test/test_ema_maf_shdat.c"
       ), (UNITY_UINT)(264));
}
...
# 275 "User/common/test/test_ema_maf_shdat.c" 3 4
       ((void *)0)
# 275 "User/common/test/test_ema_maf_shdat.c"
       ), (UNITY_UINT)(275));
}
...
void test_shdat_double_buffer_swap(void)
{
    ...
    do { if ((fabsf(out2.frequency - 60.0f) < fabsf(out1.frequency - 60.0f))) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((296))); } } while (0)
                                                   ;
}
...
void test_shdat_ema_smoothing_single_step(void)
{
    ...
    do { if ((out.frequency < 100.0f)) { } else { UnityFail( ((("EMA should dampen step change"))), (UNITY_UINT)((317))); } } while (0)
                                                             ;
    do { if ((out.frequency > 50.0f)) { } else { UnityFail( ((("EMA output should be above previous value"))), (UNITY_UINT)((319))); } } while (0)
                                                                         ;
}
...
# 334 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 334 "User/common/test/test_ema_maf_shdat.c"
...
# 335 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 335 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(335));
}
...
# 348 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 348 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(348));
    UnityAssertFloatsWithin((UNITY_FLOAT)((1.0f)), (UNITY_FLOAT)((expected)), (UNITY_FLOAT)((out.vol_line.bc)), (
# 349 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 349 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(349));
    UnityAssertFloatsWithin((UNITY_FLOAT)((1.0f)), (UNITY_FLOAT)((expected)), (UNITY_FLOAT)((out.vol_line.ca)), (
# 350 "User/common/test/test_ema_maf_shdat.c" 3 4
   ((void *)0)
# 350 "User/common/test/test_ema_maf_shdat.c"
   ), (UNITY_UINT)(350));
}
