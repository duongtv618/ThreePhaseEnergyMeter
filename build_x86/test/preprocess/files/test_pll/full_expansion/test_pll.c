...
# 44 "User/lib/test/test_pll.c" 3 4
                           3.14159265358979323846
# 44 "User/lib/test/test_pll.c"
                           ) * f * (float32_t)i / fs);
}
...
# 51 "User/lib/test/test_pll.c" 3 4
                   3.14159265358979323846
# 51 "User/lib/test/test_pll.c"
                   ) * f * (float32_t)i / fs;
    *va = 1.0f * sinf(phi);
    *vb = 1.0f * sinf(phi - (2.0f * (float32_t)
# 53 "User/lib/test/test_pll.c" 3 4
                                3.14159265358979323846
# 53 "User/lib/test/test_pll.c"
                                ) / 3.0f);
    *vc = 1.0f * sinf(phi - 2.0f * (2.0f * (float32_t)
# 54 "User/lib/test/test_pll.c" 3 4
                                       3.14159265358979323846
# 54 "User/lib/test/test_pll.c"
                                       ) / 3.0f);
}
...
# 72 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 72 "User/lib/test/test_pll.c"
   ), (UNITY_UINT)(72));
}
...
# 81 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 81 "User/lib/test/test_pll.c"
   ), (UNITY_UINT)(81));
}
...
# 88 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 88 "User/lib/test/test_pll.c"
   ), (UNITY_UINT)(88));
    UnityAssertFloatsWithin((UNITY_FLOAT)((0.01f)), (UNITY_FLOAT)((50.0f)), (UNITY_FLOAT)((pll.f0)), (
# 89 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 89 "User/lib/test/test_pll.c"
   ), (UNITY_UINT)(89));
}
...
# 97 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 97 "User/lib/test/test_pll.c"
   ), (UNITY_UINT)(97));
    UnityAssertFloatsWithin((UNITY_FLOAT)((1e-6f)), (UNITY_FLOAT)((0.0f)), (UNITY_FLOAT)((pll.SOGI.beta)), (
# 98 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 98 "User/lib/test/test_pll.c"
   ), (UNITY_UINT)(98));
}
...
void test_pll_init_3p_sets_theta_to_270(void)
{
    ...
    UnityAssertFloatsWithin((UNITY_FLOAT)((0.001f)), (UNITY_FLOAT)((270.0f)), (UNITY_FLOAT)((pll.theta)), (
# 106 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 106 "User/lib/test/test_pll.c"
   ), (UNITY_UINT)(106));
}
...
void test_pll_init_3p_sets_delta_theta(void)
{
    ...
    UnityAssertFloatsWithin((UNITY_FLOAT)((0.001f)), (UNITY_FLOAT)((expected)), (UNITY_FLOAT)((pll.delta_theta)), (
# 114 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 114 "User/lib/test/test_pll.c"
   ), (UNITY_UINT)(114));
}
...
# 126 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 126 "User/lib/test/test_pll.c"
...
# 134 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 134 "User/lib/test/test_pll.c"
...
void test_pll_is_locked_returns_0_when_counter_below_threshold(void)
{
    ...
    pll.locked = (128 * 2) - 1;
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((0)), (UNITY_INT)(UNITY_UINT32)((pll_is_locked(&pll))), (
# 142 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 142 "User/lib/test/test_pll.c"
...
void test_pll_update_1p_theta_stays_in_0_to_360(void)
{
    ...
    for (uint32_t i = 0; i < samples; i++) {
        ...
        do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((("theta out of [0, 360)"))), (UNITY_UINT)((159))); } } while (0)
                                                         ;
    }
}
...
void test_pll_update_3p_theta_stays_in_0_to_360(void)
{
    ...
    for (uint32_t i = 0; i < samples; i++) {
        ...
        do { if ((pll.theta >= 0.0f && pll.theta < 360.0f)) { } else { UnityFail( ((("theta out of [0, 360)"))), (UNITY_UINT)((174))); } } while (0)
                                                         ;
    }
}
...
# 194 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 194 "User/lib/test/test_pll.c"
   ), (UNITY_UINT)(194));
}
...
void test_pll_update_3p_frequency_estimate_within_2Hz(void)
{
    ...
    UnityAssertFloatsWithin((UNITY_FLOAT)((2.0f)), (UNITY_FLOAT)((50.0f)), (UNITY_FLOAT)((pll.fre)), (
# 209 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 209 "User/lib/test/test_pll.c"
   ), (UNITY_UINT)(209));
}
...
# 262 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 262 "User/lib/test/test_pll.c"
   ), (UNITY_UINT)(262));
}
...
void test_pll_update_3p_tracks_51Hz(void)
{
    ...
    UnityAssertFloatsWithin((UNITY_FLOAT)((2.0f)), (UNITY_FLOAT)((true_freq)), (UNITY_FLOAT)((pll.fre)), (
# 278 "User/lib/test/test_pll.c" 3 4
   ((void *)0)
# 278 "User/lib/test/test_pll.c"
   ), (UNITY_UINT)(278));
}
